package com.coship.imagepicker.ui;
...
import com.coship.imagepicker.adapter.PhotoAlbumLVAdapter;
import com.coship.imagepicker.model.PhotoAlbumLVItem;
import com.coship.imagepicker.utils.Utility;

import java.io.File;
import java.util.ArrayList;
import java.util.HashSet;

import static com.coship.imagepicker.utils.Utility.isImage;
        ...
        if (cursor != null) {
            if (cursor.moveToLast()) {
                ...
                while (true) {
                    ...
                    File parentFile = new File(imagePath).getParentFile();//获取父文件
